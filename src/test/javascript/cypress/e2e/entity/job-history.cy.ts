...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2023-06-12T12:35').blur().should('have.value', '2023-06-12T12:35');

      cy.get(`[data-cy="endDate"]`).type('2023-06-11T19:33').blur().should('have.value', '2023-06-11T19:33');
